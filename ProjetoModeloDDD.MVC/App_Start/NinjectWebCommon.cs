...
namespace ProjetoModeloDDD.MVC.App_Start
{
    ...
    using ProjetoModeloDDD.Domain.Servicos;
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind(typeof(IClienteService)).To<ClienteService>();
            kernel.Bind(typeof(IProdutoService)).To<ProdutoService>();


            kernel.Bind(typeof(IRepositoryBase<>)).To(typeof(RepositoryBase<>));
            kernel.Bind(typeof(IProdutoRepository)).To<ProdutoRepository>();
            kernel.Bind(typeof(IClienteRepository)).To<ClienteRepository>();
        }        
    }
}
